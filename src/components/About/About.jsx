    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Name */}
          <h2 className="text-2xl sm:text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">
            Vikash Yadav  
            {/* !! IT Analyst !! */}
          </h2>
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            I am Results-driven Sr. Software Developer with 7+ years of experience in the field. Motivated to devise forward-thinking solutions that meet current and future needs. Ability to collaborate with designers, developers and other stakeholders to translate design mockups into fully functional applications.
          </p>
          {/* Resume Button */}
          <a
